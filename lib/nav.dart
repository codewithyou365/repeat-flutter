...
import 'package:repeat_flutter/page/gs_cr_settings_dsc/gs_cr_settings_dsc_nav.dart';
...
enum Nav {
  ...
  gsCrSettingsDsc("/gs/cr/settings/dsc"),
  ...
  static final List<GetPage> getPages = [
    ...
    gsCrSettingsDscNav(gsCrSettingsDsc.path),
