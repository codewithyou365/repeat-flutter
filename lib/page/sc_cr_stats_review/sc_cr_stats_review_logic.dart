...
import 'sc_cr_stats_review_state.dart';

class ScCrStatsReviewLogic extends GetxController {
  static const String id = "ScCrStatsReviewLogic";
  final ScCrStatsReviewState state = ScCrStatsReviewState();
