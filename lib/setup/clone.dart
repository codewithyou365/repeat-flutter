...
import 'package:repeat_flutter/setup/git_transfer_progress.dart';
import 'package:repeat_flutter/logger/logger.dart';
import 'package:repeat_flutter/setup/settings.dart';
...
Future<void> cloneRemotePluggable({
  ...
  required Function(GitTransferProgress) progressUpdate,
