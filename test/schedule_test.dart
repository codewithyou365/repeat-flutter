...
//       entities = await Db().db.scheduleDao.findSegmentOverallPrg(30, DateTime.now());
//
...
//       var schedule = await dao.getSegmentOverallPrg("pear");
...
//       schedule = await dao.getSegmentOverallPrg("pear");
...
//       schedule = await dao.getSegmentOverallPrg("apple");
