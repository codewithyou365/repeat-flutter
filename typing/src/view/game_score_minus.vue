...
const gameTypeColumns = computed(() => [
  {text: t('gameTypeBlankItRight') + ` (${scores.value[ContentType.BLANK_IT_RIGHT.code] ?? 0})`, value: 2},
  {text: t('gameTypeWordSlicer') + ` (${scores.value[ContentType.WORD_SLICER.code] ?? 0})`, value: 2},
])
